...
// Forward optional Condition / Resource positional args onto the operator.
static void add_positional_condition_and_resource_args(Operator* op, const py::args& args) {
